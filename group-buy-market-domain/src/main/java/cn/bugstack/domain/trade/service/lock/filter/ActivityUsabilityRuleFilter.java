 ...
 * @Description: 校验活动的可用性，规则过滤【状态、有效期】
 * @Author: Daniel G
 * @Create: 2025-07-18 11:25:42
 */
@Slf4j
@Service
public class ActivityUsabilityRuleFilter implements ILogicHandler<TradeLockRuleCommandEntity,
    ...
    public TradeLockRuleFilterBackEntity apply(TradeLockRuleCommandEntity requestParameter,
        ...
        // 走到下一个责任链节点
        return next(requestParameter, dynamicContext);//这里返回null 在BusinessLinkedList中节点碰到null 遍历下一个Handler节点
    }
}
